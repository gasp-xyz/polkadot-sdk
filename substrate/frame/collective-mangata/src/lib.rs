...
const ALERT_STRING: &'static str = "ALERT!ALERT!ALERT!";
...
pub mod pallet {
	...
	pub trait Config<I: 'static = ()>: frame_system::Config {
		...
		type ProposalCloseDelay: Get<BlockNumberFor<Self>>;
	...
	#[pallet::storage]
	#[pallet::getter(fn proposal_proposed_time)]
	pub type ProposalProposedTime<T: Config<I>, I: 'static = ()> =
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		pub fn set_members(
			...
			<Self as ChangeMembers<T::AccountId>>::set_prime(prime);
...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	fn remove_proposal(proposal_hash: T::Hash) -> u32 {
		...
		ProposalProposedTime::<T, I>::remove(&proposal_hash);
